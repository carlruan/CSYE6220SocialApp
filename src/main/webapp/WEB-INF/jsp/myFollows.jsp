...
<html lang="en">
  ...
  <div>
    ...
    <c:forEach items="${requestScope.posts}" var="post">
      ...
      <tr>
        <td>
          <form id="likeForm" action="like.htm" method="POST">
      ...
      <tr>
        <td>
          ...
          <td>
        <form id="commentForm" action="comment.htm" method="POST">
          <input type="hidden" name="postId" value=${post.postId}>
          
          <input type="text" name="comment" id="commentArea">
      ...
      <tr>
        <td> 
        <form id="unfollowForm" action="unfollow.htm" method="POST">
